...
// Logger adapted for Google Cloud Platform environments. Use this middleware as early as possible in the middleware
// chain, otherwise logs might be missing.
//
// ProjectID is optional, and mainly useful for production. It is the ID of your Google Cloud Project.
func Logger(logger zerolog.Logger, projectID string) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		severity := LogSeverityInfo // For GCP.
		if status > 499 {
